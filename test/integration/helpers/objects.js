...
module.exports = function (Bookshelf) {
	...
	var Site = Bookshelf.Model.extend({
		...
		thumbnails: function () {
			return this.morphMany(Thumbnail, "imageable", [
				"ImageableType",
				"ImageableId",
			]);
		},
	...
	var Author = Bookshelf.Model.extend({
		...
		thumbnail: function () {
			return this.morphOne(Thumbnail, "imageable", [
				"ImageableType",
				"ImageableId",
			]);
		},
	...
	var Customer = Bookshelf.Model.extend({
		...
		locale: function () {
			return this.hasOne(Locale).through(
				Translation,
				"isoCode",
				"customer",
				"code",
		...
		locales: function () {
			return this.hasMany(Locale).through(
				Translation,
				"isoCode",
				"customer",
				"code",
	...
	var Locale = Bookshelf.Model.extend({
		tableName: "locales",
		customer: function () {
			return this.belongsTo(Customer).through(
				Translation,
				"isoCode",
				"customer",
				"code",
		...
		customersThrough: function () {
			return this.belongsToMany(Customer).through(
				Translation,
				"code",
				"customer",
				"isoCode",
